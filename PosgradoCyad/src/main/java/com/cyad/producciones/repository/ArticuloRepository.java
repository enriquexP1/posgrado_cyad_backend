 ...
 *
 */
@Repository("repositorio_articulo")
public interface ArticuloRepository extends JpaRepository<EArticulo, Serializable> {
	 ...
	 */
	public abstract EArticulo findById(long id);
}
