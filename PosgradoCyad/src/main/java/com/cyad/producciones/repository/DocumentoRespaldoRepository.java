 ...
 *
 */
@Repository("repositorio_documento_respaldo")
public interface DocumentoRespaldoRepository extends JpaRepository<EDocumentoRespaldo, Serializable> {
	/**
	 * metodo para realizar una busqueda de autor por id
	 * 
	 * @param id
	 * @return entidad DocumentoRespaldo
	 */
	public abstract EDocumentoRespaldo findById(long id);
}
