 ...
 *
 */
@Repository("repositorio_memoria_palabras_puente")
public interface MemoriaPalabrasPuenteRespository extends JpaRepository<EMemoriaPalabrasPuente, Serializable> {
	/**
	 ...
	 */
	public abstract EMemoriaPalabrasPuente findById(long id);
}
